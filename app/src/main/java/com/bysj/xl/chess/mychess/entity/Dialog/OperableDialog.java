...
public class OperableDialog extends MyLoading {
    ...
    public OperableDialog(@NonNull Context context, int timeout,
                          String title, String message, String ensureButtonText, String cancelButtonText, com.bysj.xl.chess.mychess.entity.Dialog.Loading.timeOutListner timeOutListner) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button bt_ensure = view.findViewById(R.id.operable_dialog_ensure);
        Button bt_cancel = view.findViewById(R.id.operale_dialog_cancel);
        TextView tv_msg = view.findViewById(R.id.operable_dialog_message);
        TextView tv_title = view.findViewById(R.id.operable_dialog_title);
