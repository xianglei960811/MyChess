...
import com.bysj.xl.chess.mychess.entity.Dialog.DownLoading.DownLoadBar;
...
public class DownLoadingDialog extends MyLoading {
    ...
    public DownLoadingDialog(@NonNull Context context, int s, com.bysj.xl.chess.mychess.entity.Dialog.Loading.timeOutListner timeOutListner) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadBar = view.findViewById(R.id.down_loading_bar);
